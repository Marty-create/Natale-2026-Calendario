...
function renderizzaContenuto(data, giorno) {
    ...
    if (data.minigioco) {
        ...
        // Se il percorso contiene "minigiochi/", lo tolgo (per la struttura piatta)
        minigiocoPath = minigiocoPath.replace('minigiochi/', '');
        html += `<iframe src="${minigiocoPath}" allow="autoplay; encrypted-media" style="width:100%; height:400px; border:none; border-radius:12px; margin-top:15px; background:#0a0e1a;"></iframe>`;
    }
